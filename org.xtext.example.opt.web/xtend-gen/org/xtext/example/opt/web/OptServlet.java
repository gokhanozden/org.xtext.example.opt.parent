...
import org.xtext.example.opt.web.OptWebSetup;
...
public class OptServlet extends XtextServlet {
  ...
  public void init() {
    try {
      ...
      OptWebSetup _optWebSetup = new OptWebSetup(executorServiceProvider);
      _optWebSetup.createInjectorAndDoEMFRegistration();
    } catch (Throwable _e) {
